...
public class Constants {
    ...
    public static class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.ifttw";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "If This Then What";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.ifttw.sync";
    ...
    public static class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.ifttw.";
